...
DROP TABLE IF EXISTS event_oper_types;
...
CREATE TABLE IF NOT EXISTS events_history (
    ...
    operations_type_id INTEGER REFERENCES event_operations_types(id) ON DELETE CASCADE,
    entity_id INTEGER NOT NULL,
    date_time TIMESTAMP
);

CREATE TABLE IF NOT EXISTS films_reviews_like(
     review_id INTEGER REFERENCES film_reviews(id) ON DELETE CASCADE,
     user_id INTEGER REFERENCES users(id) ON DELETE CASCADE,
